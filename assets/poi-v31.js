...
const PoiApp={
 ...
 render(){
  ...
  document.querySelector("#poiList").innerHTML=rows.length?rows.map(p=>{
   ...
   links.push(`<span class="pending-label">${p.verification?.practicalDataStatus==="pending_web_verification"?"⏳ Πρακτικά στοιχεία: εκκρεμούν":"⚠️ Εκκρεμεί επαλήθευση σημείου"}</span>`);
